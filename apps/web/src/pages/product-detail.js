...
const ProductDetailPage = () => {
    ...
    if (!product) {
        return _jsx("div", { className: "py-10 text-center text-sm text-slate-500", children: "Product not found." });
    }
